...
function App() {
    ...
    if (!auth.isAuthenticated) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-[var(--tan-100)] px-4 text-center text-[var(--coolgrey-700)]">
    ...
    return (
        <div className="flex min-h-screen flex-col bg-[var(--tan-100)] px-4 py-8 text-[var(--coolgrey-700)] sm:px-8">
